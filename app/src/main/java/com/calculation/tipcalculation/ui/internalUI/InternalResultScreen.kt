...
//    val reportData = settingsViewModel.reportData.value
//
...
//                    value = String.format(Locale.getDefault(), "%.2f", calculationData.average)
//                )
//            }
//            item {
//                ResultCard(
//                    title = "Выбранный диаметр",
//                    value = String.format(Locale.getDefault(), "%.2f", calculationData.selectedDiameter)
//                )
//            }
//            item {
//                ResultCard(
//                    title = "vp выбранного наконечника",
//                    value = String.format(Locale.getDefault(), "%.2f", calculationData.selectedVp)
//                )
//            }
//            item {
//                Button(onClick = {
